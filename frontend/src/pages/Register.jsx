  ...
  return (
    <div className="min-h-screen bg-[#f9f9f7] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-[1.5rem] shadow-[0_40px_40px_-15px_rgba(47,51,50,0.08)] border border-[#afb3b0]/10 p-10">
        ...
        <h1 className="font-['Newsreader'] text-3xl font-semibold text-[#2f3332] mb-2">Create account</h1>
        <p className="text-sm text-[#5c605e] mb-8">Start tracking your career growth</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-[#5c605e] mb-1.5 uppercase tracking-wider">Confirm Password</label>
            <input
              type="password"
              value={confirm}
        ...
        <p className="text-sm text-center text-[#5c605e] mt-6">
          ...
          <Link to="/login" className="text-[#506454] font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
